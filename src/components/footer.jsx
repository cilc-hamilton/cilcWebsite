            ...
            <div className="bg-cilcdarkblue w-screen py-12 min-[1000px]:px-24 min-[900px]:px-16 px-12 flex flex-col h-fit min-[1000px]:gap-x-16 min-[900px]:gap-x-12 gap-x-8 gap-y-8 p-8p">
                <div className="flex flex-col gap-8">
                    <div className="flex flex-row items-center">
                        <Link className="w-fit flex flex-row cursor-pointer items-center bg-white" to="/">
                            <img className="h-16 sm:h-24" src="/images/logo.png" alt="CILC Logo"></img>
                            <div className="hidden sm:flex flex-col pl-6">
                                <h1 style={{fontFamily: 'century'}} className="font-light -mb-0.5 text-2xl text-[#287CC0]">Children's</h1>
                                <h1 style={{fontFamily: 'century'}} className="font-light -mb-0.5 -mt-0.5 text-2xl text-[#287CC0]">International</h1>
                                <h1 style={{fontFamily: 'century'}} className="font-light -mb-0.5 -mt-0.5 text-2xl text-[#287CC0]">Learning</h1>
                                <h1 style={{fontFamily: 'century'}} className="font-light -mt-0.5 text-2xl text-[#287CC0]">Centre</h1>
                            </div>
                        </Link>
                        <div className="grow"/>
                        <Donatebutton/>

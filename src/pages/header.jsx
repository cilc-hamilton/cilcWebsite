...
function Header(props){
    ...
    location = location.pathname.replace("-", " ").replace("/", "").split(" ")
    ...
    return (
        ...
        <Navbar/>
        <Mobilenav/>
            <div className = "w-screen overflow-hidden flex flex-row items-center justify-center h-fit min-[900px]:h-[600px] min-[900px]:w-screen">
                <div className = "w-[30vw] flex flex-col items-center justify-center h-full grow-0 box-border p-8 bg-cilcdarkblue">
                    <h1 className = "font-semibold text-white text-5xl pb-2">{location.join(" ")}</h1>
                ...
                <div className = "flex items-center justify-center w-[70vw] overflow-hidden">
                    <img className = "w-[70vw] h-[600px] object-cover" src = {props.image}></img>
                </div>
            </div>
        </>
    )

            ...
            <div className="flex flex-col w-screen absolute top-0 min-[900px]:top-36">
                ...
                <Section color="white">
                    ...
                    <Profileholder>
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Sanjum Hunjan" desc="First-year medical student at McMaster University and recent graduate of the Biomedical Discovery & Commercialization undergraduate programme. Has been involved with the CILC since 2019. A passionate and engaged member of the community who actively contributes to promoting diversity and equity within all domains of Hamilton and area."/>
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Isabella Marchese" desc="Chair of the By-Laws and Policies committee, Isabella has been a member of the CILC since 1994 because she firmly embraces the mission and vision of the CILC. Before becoming a board member, she frequently visited the CILC with her elementary and Immigrants Working Centre classes. She has served on the board as Vice President, President and on various committees during the 1990s-2010."/>
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Mike Paquet" desc="During his 27-year career in fund development, Mike Paquet has helped several community-based and grassroots non-profit groups throughout Southern Ontario to implement long-term sustainable fundraising and resource development programs. Mike has enabled several organizations to discover the enormous potential of major gift fundraising. Currently, Mike is the Chief Fundraising Strategist of People First Fundraising Solutions in Hamilton."/>
                        <Profile image="/images/blankProfile.jpg" name="Sahanah Thirukumar" desc="Honours Life Sciences (BSc) graduate from McMaster University. She has been a CILC volunteer since the fall of 2018. Sahanah aims to truly dedicate her skills and efforts to CILC's benevolent objectives and commit to promoting diversity, equity and inclusivity in our communities. Sahanah chairs the Communications Committee."/>
                        <Profile image="/images/blankProfile.jpg" name="Jason Townsend" desc="Honours Bachelor of Commerce (BCom) candidate at the DeGroote School of Business at McMaster University in Hamilton. Jason previously volunteered in the organization's finance team since 2019."/>
                    </Profileholder>
                </Section>
                <Footer/>
            </div>

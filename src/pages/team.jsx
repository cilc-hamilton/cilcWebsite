        ...
        <>
            <div className="flex flex-col w-screen absolute top-0 min-[900px]:top-36">
                ...
                <Section color="white">
                    ...
                    <hr className="bg-deepblue"/>
                    <Profileholder>
                        <Profile image="/images/blankProfile.jpg" name="Melissa Adoma" desc={
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Simran Chugh" desc={
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Sanjum Hunjam" desc={
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Isabella Marchese" desc={
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Mike Paquet" desc={
                            "Chair of the Fundraising Action Team, Mike has been a member of the CILC board since 2022 after working with them as a consultant to enhance their fund development strategies. During his 28-year career in fund development, Mike Paquet has helped several community-based and grassroots non-profit groups throughout Southern Ontario to implement long-term sustainable fundraising and resource development programs. Mike has enabled several organizations to discover the enormous potential of major gift fundraising.  Currently, Mike is the Chief Fundraising Strategist of People First Fundraising Solutions in Hamilton."
                        }/>
                        <Profile image="/images/blankProfile.jpg" name="Gemma Patey" desc={
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Andre Preclaro" desc={
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Sahanah Thirukumar" desc={
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Jason Townsend" desc={
                        ...
                        <Profile image="/images/blankProfile.jpg" name="Riya Trivedi" desc={
